...
namespace Alura.ListaLeitura.Modelos
{
    public static class TipoListaLeituraExtensions
    {
		...
		public static string ParaString(this TipoListaLeitura tipo) => mapa.First(s => s.Value == tipo).Key;
		public static TipoListaLeitura ParaTipo(this string texto) => mapa.First(t => t.Key == texto).Value;
	}
